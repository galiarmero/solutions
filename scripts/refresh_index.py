...
def main():
    ...
    ordered_categories = ['array', 'string', 'map', 'set', 'stack', 'deque', 'priority queue', 'heap', 'tree', 'depth-first search', 'breadth-first search', 'math', 'dynamic programming', 'greedy', 'binary search']
